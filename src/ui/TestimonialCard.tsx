...
function PlatformBadge({ platform }: { platform: 'x' | 'discord' }) {
  return (
    <div className="h-4 w-4 rounded-full bg-black/80 flex items-center justify-center border border-white/20">
      {platform === 'x' ? (
